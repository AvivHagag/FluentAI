...
const TaskSideBar: React.FC<TaskSideBarProps> = ({
  ...
  return (
    <div className="flex" dir="rtl">
      ...
      >
        <div
          className={`flex flex-col min-h-96 h-auto py-12 px-1 sm:px-2 sm:py-3 text-lightRed text-sm md:text-xl whitespace-nowrap rounded-r-lg border-l border-mediumBeige ${
            isSidebarOpen
              ? "z-[500]"
