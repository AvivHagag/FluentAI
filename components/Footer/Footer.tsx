...
export default function Footer() {
  return (
    <footer className="bg-mediumBeige text-darkRed lg:text-left text-sm sm:text-base">
      <div className="flex items-center justify-center border-b p-3 lg:justify-between">
        ...
        <div className="flex justify-center items-center">
          <a
            href="https://github.com/AvivHagag/FluentAI-Test"
            target="_blank"
            rel="FluentAI"
          >
            <svg
      ...
      <div className="mx-2 pt-3 px-1 text-center md:text-left">
